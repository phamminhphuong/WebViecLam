                ...
                <div class="box-content">
					...
					<div class="content-box group-collapse">
						...
						<div class="col-xs-6 offset20 push-left-20">
							<div class="info-user1">
								<p><span class="label">Họ tên: </span><b class="value text-primary">{!!$hoSo->HoTen!!}</b></p>
								<p><span class="label">Số điện thoại: </span><b class="value text-primary">{!!$hoSo->DienThoai!!}</b></p>
							</div>
						</div>
					...
					<form action="tao-ho-so" method="POST" enctype="multipart/form-data" class="create-pro-form" id="form_ho_so">
                        ...
                        <article class="content-box group-collapse create-pro-form taohoso" id="div_tao_hs">
							<div id="seeker-info">
								<div class="group-field">
									<label class="label1">
										Họ tên <span class="icon icon-xs icon-hoa-thi"></span>
									</label>
								...
								<div class="group-field">
									<label class="label1">
										Số điện thoại <span class="icon icon-xs icon-hoa-thi"></span>
									</label>
								...
								<div class="group-field">
									<label class="label1">
										Hình ảnh <span class="icon icon-xs icon-hoa-thi"></span>
									</label>
                                ...
                                <div class="group-field">
									...
									<input type="date" name="NgaySinh" class="w253 input-has-tooltip"/>
									<div class="clearfix"></div>
								</div>
                        ...
                        <article class="content-box group-collapse create-pro-form taohoso" id="div_tao_hs">
							...
							<div class="group-field">
                                    <label class="label1">
                                        Tình trạng hôn nhân <span class="icon icon-xs icon-hoa-thi"></span>
                                    </label>
							...
							<div class="group-field">
								<label for="" class="label1">
									Lương mong muốn <span class="icon-hoa-thi"></span>
								</label>
								<div class="group-right">
							...
							<div class="group-field">
								<label for="" class="label1">
									Nguyện vọng làm việc <span class="icon-hoa-thi"></span>
								</label>
								<div class="group-right">
								...
								<div class="group-right">
									<div class="style-button w260">
										<div class="select2-container select-style no-style-button w260" id="s2id_level">
											...
											<select style="margin-top:-20px;" id="level" name="MaTrinhDo" class="select-style no-style-button w260 select2-offscreen" tabindex="-1">
							...
							<div class="group-field">
								<label for="" class="label1">
									Chứng chỉ <span class="icon-hoa-thi"></span>
								</label>
								<div class="group-right">
									<div class="style-button w260">
										<div class="select2-container select-style no-style-button w260" id="s2id_level">
							...
							<div class="group-field">
								<label for="" class="label1">
									Ngành <span class="icon-hoa-thi"></span>
								</label>
								<div class="group-right">
									<div class="style-button w260">
										<div class="select2-container select-style no-style-button w260" id="s2id_level">
