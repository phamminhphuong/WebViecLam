            ...
            <div class="inner-10">
                <div class="icon-seekers col-xs-4 offset10">
                    <div class="border-1 border-2">
                        ...
                        <a href="https://www.timviecnhanh.com/dang-nhap/nguoi-tim-viec?referral_url=http%3A%2F%2Fwww.timviecnhanh.com%2F" onClick="ga('send', 'event', 'contact', 'Click', 'nguoitimviecdangnhap’, 1);"
                            class="btn btn-big btn-danger">
                            Đăng nhập Người tìm việc
                        </a>
                        <a href="https://www.timviecnhanh.com/nguoi-tim-viec/huong-dan-dang-nhap-dg22.html" onClick="ga('send', 'event', 'contact', 'Click', 'nhatuyendungdangnhap’, 1);"
                            class="icon-guide" target="_blank">
                ...
                <div class="icon-employers col-xs-4 offset10">
                    <div class="border-1 border-2">
                        ...
                        <a href="https://www.timviecnhanh.com/dang-nhap/nha-tuyen-dung?referral_url=http%3A%2F%2Fwww.timviecnhanh.com%2F" class="btn btn-big btn-danger">
                            Đăng nhập Nhà tuyển dụng
                        </a>
                        <a href="https://www.timviecnhanh.com/nha-tuyen-dung/huong-dan-dang-nhap-tai-khoan-dg30.html" class="icon-guide" target="_blank">
                            <span class="icon icon-arrow icon-xs"></span>
                ...
                <div class="row ml10 mr10">
                    <div class="box-create">
                        <div class="btn-create btn-create-hsm">
                            <a class="btn-create-hs" href="https://www.timviecnhanh.com/dang-ky">
                                <span class="txt-head">Đăng ký</span>
                                <span class="txt-des">1 phút đăng ký, xem ngay hàng trăm việc làm</span>
                                <i class="icon-register-home-1"></i>
                            </a>
                        </div>
