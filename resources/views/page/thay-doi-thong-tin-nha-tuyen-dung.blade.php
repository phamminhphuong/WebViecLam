                ...
                <div class="box-content">
                    <header class="block-title">
                        <h3 class="title font-roboto text-primary">
                            <span class="text">Nhà tuyển dụng thay đổi thông tin</span>
                    ...
                    <div class="entry">
                        ...
                        @endif
                        <br/>
                        <form action="thay-doi-thong-tin-nha-tuyen-dung1" method="POST" enctype="multipart/form-data" class="form-employers-register">
                            ...
                            <div class="row-btn">
                                <button type="submit" class="btn-big btn-danger col-xs-2 col-push-2 w140">
                                    <i class="icon-sprite-hs icon_sm_2017 icon-register-home_2017"></i>Cập nhật
                                </button>
                                <div class="clearfix"></div>
                            </div>
                        </form>
                        <form action="thay-doi-thong-tin-nha-tuyen-dung2" method="POST" enctype="multipart/form-data" class="form-employers-register">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            ...
                            <div class="group-field">
                                ...
                                <input type="text" id="name" name="TenNTD" value="{!!$nhatuyendung->TenNTD!!}" class="input-has-tooltip">
                            ...
                            <div class="group-field">
                                ...
                                <input type="text" id="address" name="DiaChi" value="{!!$nhatuyendung->DiaChi!!}"  class="input-has-tooltip">
                                <div class="block-has-tooltip">
                                    <div class="tooltip-huong-dan">
                            ...
                            <div class="group-field">
                                ...
                                <input type="text" id="phone" value="{!!$nhatuyendung->DienThoai!!}" name="DienThoai">
                            </div>
                            ...
                            <div class="group-field">
                                ...
                                <input type="text" id="diaChiWeb" disabled="disabled" value="{!!$nhatuyendung->DiaChiWeb!!}" name="DiaChiWeb">
                            </div>
                            <div class="group-field">
                                <label class="label-form" for="">
                                    Sơ lược về công ty
                                ...
                                <textarea id="description" name="GioiThieu" class="input-has-tooltip" style="height: 300px;">{!!$nhatuyendung->GioiThieu!!}</textarea>
                                <div class="block-has-tooltip">
                                    <div class="tooltip-huong-dan">
