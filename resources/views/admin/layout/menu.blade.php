    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="admin/chungchi/list"><i class="far fa-circle small"> </i> Danh sách chứng chỉ</a></li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="admin/phieudangtuyen/list"><i class="far fa-circle small"> </i> Danh sách phiếu đăng tuyển</a></li>
              <li><a href="admin/phieudangtuyen/add"><i class="far fa-circle small"> </i>  Thêm phiếu đăng tuyển</a></li>
            </ul>
          </li>
        <li class="treeview">
            <a href="#">
              <i class="fas fa-users"></i>  <span> Hồ sơ xin việc</span>
              <span class="pull-right-container"> 
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="admin/hosoxinviec/list"><i class="far fa-circle small"> </i> Danh sách hồ sơ</a></li>
              <li><a href="admin/hosoxinviec/add"><i class="far fa-circle small"> </i>  Thêm hồ sơ</a></li>
            </ul>
          </li>
         
        <li class="treeview">
            <a href="#">
              <i class="fab fa-angular"></i>  <span> Quảng cáo</span>
              <span class="pull-right-container"> 
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="active"><a href="admin/quangcao/list"><i class="far fa-circle small"> </i> Danh sách quảng cáo</a></li>
