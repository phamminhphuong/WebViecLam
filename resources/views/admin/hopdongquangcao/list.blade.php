...
@section('title')
    Danh sách hợp đồng quảng cáo
@endsection
@section('content')
<section class="content container-fluid">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Danh sách hợp đồng quảng cáo</h3>
            <h3>
                <a href="admin/hopdongquangcao/add">Tạo mới</a>
            </h3>
        </div>
        <!-- /.box-header -->   
        <div class="box-body">
...
: activate to sort column ascending" style="width: 239.799px;">
                            ...
                            <tbody>
                                @foreach($hopdongquangcao as $hdqc)
                                <tr role="row" class="odd">
                                    <td class="sorting_1">
                                        {!!$hdqc->id!!}
                                    </td>
                                    <td>
                                        {!!$hdqc->nhatuyendung->TenNTD!!}
                                    </td>
                                    <td>
                                        {!!$hdqc->NgayLap!!}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="admin/hopdongquangcao/detail/{!!$hdqc->id!!}">Chi tiết</a> |
                                        <a href="admin/hopdongquangcao/delete/{!!$hdqc->id!!}">Xóa</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
