@extends('admin.layout.index') @section('title') Thêm nhà tuyển dụng @endsection @section('content')
<section class="content container-fluid">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Tạo mới nhà tuyển dụng</h3>
        </div>
        <div class="box-header with-border">
        ...
        @if(count($errors) >0) 
         ...
         @endif
        <br>
        <form action="admin/nhatuyendung/add" method="post" enctype="multipart/form-data">
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input class="form-control text-box single-line" data-val="true" data-val-length="The field TenSanPham must be a string with a maximum length of 50."
                            data-val-length-max="50" id="TenNTD" name="TenNTD" type="text" value="" placeholder="Nhập tên nhà tuyển dụng">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                        <b class="control-label col-md-2"> Tài khoản</b>
                        <div class="col-md-10">
